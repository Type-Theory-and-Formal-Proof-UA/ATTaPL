...
# Порядок як у книзі: глави 1..10, тоді додаток A, тоді бібліографія й покажчик.
# Сама лише абетка поставила б "appa"/"index"/"refs" ПЕРЕД "ch01".
BACK = {"appa": 11, "refs": 12, "index": 13}
