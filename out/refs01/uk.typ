...
#heading(level: 1, outlined: true)[Бібліографія]
...
#refentry[Abadi, Martín, Luca Cardelli, Pierre-Louis Curien, and Jean-Jacques Lévy. Explicit substitutions. #emph[Journal of Functional Programming], 1(4):375–416, 1991. Summary in #emph[ACM Symposium on Principles of Programming Languages (POPL), San Francisco,] #emph[California], 1990.]

#refentry[Adams, Rolf, Walter Tichy, and Annette Weinert. The cost of selective recompilation and environment processing. #emph[ACM Transactions on Software Engineering and] #emph[Methodology], 3(1):3–28, January 1994.]

#refentry[Ahmed, Amal, Limin Jia, and David Walker. Reasoning about hierarchical storage. In #emph[IEEE Symposium on Logic in Computer Science (LICS), Ottawa, Canada], pages 33–44, June 2003.]
...
#refentry[Ancona, Davide and Elena Zucca. A calculus of module systems. #emph[Journal of Functional] #emph[Programming], 12(2):91–132, March 2002.]

#refentry[Appel, Andrew W. Foundational proof-carrying code. In #emph[IEEE Symposium on Logic in] #emph[Computer Science (LICS), Boston, Massachusetts], pages 247–258, June 2001.]

#refentry[Appel, Andrew W. and Amy P. Felty. A semantic model of types and machine instructions for proof-carrying code. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles] #emph[of Programming Languages (POPL), Boston, Massachusetts], pages 243–253, January 2000.]

#refentry[Aspinall, David. Subtyping with singleton types. In #emph[International Workshop on Computer Science Logic (CSL), Kazimierz, Poland], volume 933 of #emph[Lecture Notes in Computer Science], pages 1–15. Springer-Verlag, September 1994.]

#refentry[Aspinall, David and Martin Hofmann. Another type system for in-place update. In #emph[European Symposium on Programming (ESOP), Grenoble, France], volume 2305 of #emph[Lecture Notes in Computer Science], pages 36–52. Springer-Verlag, April 2002.]
...
#refentry[Berthomieu, Bernard. Tagged types: A theory of order sorted types for tagged expressions. Research Report 93083, LAAS, 7, avenue du Colonel Roche, 31077 Toulouse, France, March 1993.]

#refentry[Berthomieu, Bernard and Camille le Moniès de Sagazan. A calculus of tagged types, with applications to process languages. In #emph[Workshop on Types for Program Analysis] #emph[(TPA)], informal proceedings, pages 1–15, May 1995.]

#refentry[Biagioni, Edoardo, Nicholas Haines, Robert Harper, Peter Lee, Brian G. Milnes, and Eliot B. Moss. Signatures for a protocol stack: A systems application of Standard ML. In #emph[ACM Symposium on Lisp and Functional Programming (LFP), Orlando,] #emph[Florida], pages 55–64, June 1994.]

#refentry[Bierman, G. M., A. M. Pitts, and C. V. Russo. Operational properties of Lily, a polymorphic linear lambda calculus with recursion. In #emph[Workshop on Higher Order Operational Techniques in Semantics (HOOTS), Montréal, Québec], volume 41 of #emph[Electronic] #emph[Notes in Theoretical Computer Science]. Elsevier, September 2000.]
...
#refentry[Blume, Matthias and Andrew W. Appel. Hierarchical modularity. #emph[ACM Transactions] #emph[on Programming Languages and Systems], 21(4):813–847, 1999.]

#refentry[Bonniot, Daniel. Type-checking multi-methods in ML (a modular approach). In #emph[International Workshop on Foundations of Object-Oriented Languages (FOOL)], informal proceedings, January 2002.]

#refentry[Bourdoncle, François and Stephan Merz. Type-checking higher-order polymorphic multi-methods. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), Paris, France], pages 302–315, January 1997.]

#refentry[Bracha, Gilad and William R. Cook. Mixin-based inheritance. In #emph[ACM SIGPLAN Conference on Object Oriented Programming: Systems, Languages, and Applications (OOPSLA)/European Conference on Object-Oriented Programming (ECOOP), Ottawa, Ontario], pages 303–311, October 1990.]

#refentry[Brandt, Michael and Fritz Henglein. Coinductive axiomatization of recursive type equality and subtyping. In #emph[International Conference on Typed Lambda Calculi and] #emph[Applications (TLCA), Nancy, France], volume 1210 of #emph[Lecture Notes in Computer] #emph[Science], pages 63–81. Springer-Verlag, April 1997. Full version in #emph[Fundamenta] #emph[Informaticae], 33:309–338, 1998.]

#refentry[Breazu-Tannen, Val, Thierry Coquand, Carl Gunter, and Andre Scedrov. Inheritance as implicit coercion. #emph[Information and Computation], 93(1):172–221, July 1991. Also in C. A. Gunter and J. C. Mitchell, editors, #emph[Theoretical Aspects of Object-Oriented] #emph[Programming: Types, Semantics, and Language Design], MIT Press, 1994.]

#refentry[Bruce, Kim B. Typing in object-oriented languages: Achieving expressibility and safety, 1995. Available through http:\//www.cs.williams.edu/\~kim.]

#refentry[Bruce, Kim B. #emph[Foundations of Object-Oriented Languages: Types and Semantics]. MIT Press, 2002.]

#refentry[Bruce, Kim B., Luca Cardelli, Giuseppe Castagna, the Hopkins Objects Group (Jonathan Eifrig, Scott Smith, Valery Trifonov), Gary T. Leavens, and Benjamin Pierce. On binary methods. #emph[Theory and Practice of Object Systems], 1(3):221–242, 1996.]
...
#refentry[Cardelli, Luca. A polymorphic λ-calculus with Type:Type. Research report 10, DEC/Compaq Systems Research Center, May 1986.]

#refentry[Cardelli, Luca. Phase distinctions in type theory, 1988a. Manuscript, available from http:\//www.luca.demon.co.uk.]

#refentry[Cardelli, Luca. Typechecking dependent types and subtypes. In #emph[Foundations of Logic] #emph[and Functional Programming, Trento, Italy, (]December, 1986#emph[)], volume 306 of #emph[Lecture Notes in Computer Science], pages 45–57. Springer-Verlag, 1988b.]

#refentry[Cardelli, Luca. Program fragments, linking, and modularization. In #emph[ACM SIGPLAN–] #emph[SIGACT Symposium on Principles of Programming Languages (POPL), Paris, France], pages 266–277, January 1997.]

#refentry[Cardelli, Luca, James Donahue, Mick Jordan, Bill Kalsow, and Greg Nelson. The Modula-3 type system. In #emph[Proceedings of the Sixteenth Annual ACM Symposium] #emph[on Principles of Programming Languages], pages 202–212, January 1989.]
...
#refentry[Chaki, Sagar, Sriram K. Rajamani, and Jakob Rehof. Types as models: Model checking message-passing programs. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of] #emph[Programming Languages (POPL), Portland, Oregon], pages 45–57, 2002.]

#refentry[Chirimar, Jawahar, Carl A. Gunter, and Jon G. Riecke. Reference counting as a computational interpretation of linear logic. #emph[Journal of Functional Programming], 6(2): 195–244, March 1996.]

#refentry[Christiansen, Morten Voetmann and Per Velschow. Region-based memory management in Java. Master’s thesis, University of Copenhagen, Department of Computer Science, 1998.]

#refentry[Church, Alonzo. #emph[The Calculi of Lambda Conversion]. Princeton University Press, 1941.]

#refentry[Church, Alonzo. The weak theory of implication. #emph[Kontroliertes Denken: Untersuchungen zum Logikkalk ul und zur Logik der Einzelwissenschaften], pages 22–37, 1951.]

#refentry[Clement, Dominique, Joelle Despeyroux, Thierry Despeyroux, and Gilles Kahn. A simple applicative language: Mini-ML. In #emph[ACM Symposium on Lisp and Functional] #emph[Programming (LFP), Cambridge, Massachusetts], pages 13–27, August 1986.]

#refentry[Colby, Christopher, Peter Lee, George C. Necula, Fred Blau, Mark Plesko, and Kenneth Cline. A certifying compiler for Java. #emph[ACM SIGPLAN Notices], 35(5):95–107, May 2000.]
...
#refentry[Coquand, Thierry. Pattern matching with dependent types. In #emph[Workshop on] #emph[Types for Proofs and Programs (TYPES), Båstad, Sweden], informal proceedings. Available from ftp:\//ftp.cs.chalmers.se/pub/cs-reports/baastad. 92/proc.ps.Z, June 1992.]

#refentry[Coquand, Thierry and Gérard Huet. The calculus of constructions. #emph[Information and] #emph[Computation], 76(2–3):95–120, February/March 1988.]

#refentry[Coquand, Thierry, Randy Pollack, and Makoto Takeyama. A logical framework with dependently typed records. In #emph[International Conference on Typed Lambda Calculi] #emph[and Applications (TLCA), Valencia, Spain], volume 2701 of #emph[Lecture Notes in Computer Science], pages 105–119. Springer-Verlag, June 2003.]

#refentry[Courant, Judicaël. Strong normalization with singleton types. In #emph[Workshop on Intersection Types and Related Systems (ITRS), Copenhagen, Denmark], volume 70 of #emph[Electronic Notes in Theoretical Computer Science]. Elsevier, July 2002.]

#refentry[Crank, Erik and Matthias Felleisen. Parameter-passing and the lambda calculus. In #emph[ACM Symposium on Principles of Programming Languages (POPL), Orlando,] #emph[Florida], pages 233–244, January 1991.]

#refentry[Crary, Karl. A simple proof technique for certain parametricity results. In #emph[ACM SIGPLAN International Conference on Functional Programming (ICFP), Paris, France], pages 82–89, September 1999.]

#refentry[Crary, Karl. Toward a foundational typed assembly language. In #emph[ACM SIGPLAN–] #emph[SIGACT Symposium on Principles of Programming Languages (POPL), New Orleans,] #emph[Louisiana], pages 198–212, January 2003.]

#refentry[Crary, Karl, Robert Harper, and Sidd Puri. What is a recursive module? In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI)], pages 50–63, May 1999.]
...
#refentry[DeLine, Rob and Manuel Fähndrich. Enforcing high-level protocols in low-level software. In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI), Snowbird, Utah], pages 59–69, June 2001.]

#refentry[Donahue, James and Alan Demers. Data types are values. #emph[ACM Transactions on] #emph[Programming Languages and Systems], 7(3):426–445, July 1985.]

#refentry[Došen, Kosta. A historical introduction to substructural logics. In K. Došen and P. Schroeder-Heister, editors, #emph[Substructural Logics], pages 1–30. Oxford University Press, 1993.]
...
#refentry[Erhard, Thomas. A categorical semantics of constructions. In #emph[IEEE Symposium on] #emph[Logic in Computer Science (LICS), Edinburgh, Scotland], pages 264–273, July 1988.]

#refentry[Fähndrich, Manuel. Bane#emph[: A Library for Scalable Constraint-Based Program Analysis]. PhD thesis, University of California at Berkeley, Berkeley, California, 1999.]
...
#refentry[Fluet, Matthew. Monadic regions. In #emph[Workshop on Semantics, Program Analysis and] #emph[Computing Environments for Memory Management (SPACE)], informal proceedings, January 2004.]
...
#refentry[Fuh, You-Chin and Prateek Mishra. Type inference with subtypes. In #emph[European Symposium on Programming (ESOP), Nancy, France], volume 300 of #emph[Lecture Notes in] #emph[Computer Science], pages 94–114. Springer-Verlag, March 1988.]

#refentry[Furuse, Jun P. and Jacques Garrigue. A label-selective lambda-calculus with optional arguments and its compilation method. RIMS Preprint 1041, Kyoto University, October 1995.]

#refentry[Garcia, Ronald, Jaakko Jarvi, Andrew Lumsdaine, Jeremy Siek, and Jeremia h Willcock. A comparative study of language support for generic programming. In #emph[ACM] #emph[SIGPLAN Conference on Object Oriented Programming: Systems, Languages, and] #emph[Applications (OOPSLA), Anaheim, California], pages 115–134, October 2003.]

#refentry[Garrigue, Jacques. Programming with polymorphic variants. In #emph[ACM SIGPLAN Workshop on ML], informal proceedings, September 1998.]

#refentry[Garrigue, Jacques. Code reuse through polymorphic variants. In #emph[Workshop on Foundations of Software Engineering (FOSE)], November 2000.]

#refentry[Garrigue, Jacques. Simple type inference for structural polymorphism. In #emph[International Workshop on Foundations of Object-Oriented Languages (FOOL)], informal proceedings, January 2002.]
...
#refentry[Gay, David and Alexander Aiken. Language support for regions. In #emph[ACM SIGPLAN] #emph[Conference on Programming Language Design and Implementation (PLDI), Snowbird, Utah], pages 70–80, June 2001.]
...
#refentry[Girard, Jean-Yves. Linear logic. #emph[Theoretical Computer Science], 50:1–102, 1987.]

#refentry[Girard, Jean-Yves. Light linear logic. #emph[Information and Computation], 143:175–204, 1998.]

#refentry[Girard, Jean-Yves, Yves Lafont, and Paul Taylor. #emph[Proofs and Types], volume 7 of #emph[Cambridge Tracts in Theoretical Computer Science]. Cambridge University Press, 1989.]

#refentry[Glew, Neal. Type dispatch for named hierarchical types. In #emph[ACM SIGPLAN International Conference on Functional Programming (ICFP), Paris, France], pages 172–182, 1999.]

#refentry[GNU. GNU C library, version 2.2.5, 2001. Available from http:\//www.gnu.org/ manual/glibc-2.2.5/html\_mono/libc.html.]

#refentry[Goguen, Healfdene. #emph[A Typed Operational Semantics for Type Theory]. PhD thesis, LFCS, University of Edinburgh, Edinburgh, Scotland, 1994. Report ESC-LFCS-94- 304.]

#refentry[Gordon, Andrew D. Bisimilarity as a theory of functional programming. In #emph[Workshop] #emph[on the Mathematical Foundations of Programming Semantics (MFPS), New Orleans,] #emph[Louisiana], volume 1 of #emph[Electronic Notes in Theoretical Computer Science]. Elsevier, April 1995.]
...
#refentry[Gordon, Michael J., Robin Milner, and Christopher P. Wadsworth. #emph[Edinburgh LCF], volume 78 of #emph[Lecture Notes in Computer Science]. Springer-Verlag, 1979.]

#refentry[Gough, John. #emph[Compiling for the .NET Common Language Runtime]. .NET series. Prentice Hall, 2002.]

#refentry[Grossman, Dan, Greg Morrisett, Trevor Jim, Michael Hicks, Yanling Wang, and James Cheney. Region-based memory management in Cyclone. In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI), Berlin, Germany], pages 282–293, 2002.]

#refentry[Gustavsson, Jörgen and Josef Svenningsson. Constraint abstractions. In #emph[Symposium] #emph[on Programs as Data Objects (PADO), Aarhus, Denmark], volume 2053 of #emph[Lecture] #emph[Notes in Computer Science], pages 63–83. Springer-Verlag, May 2001.]

#refentry[Hallenberg, Niels, Martin Elsman, and Mads Tofte. Combining region inference and garbage collection. In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI), Berlin, Germany], pages 141–152, June 2002.]

#refentry[Hallgren, Thomas and Aarne Ranta. An extensible proof text editor (abstract). In #emph[International Conference on Logic for Programming and Automated Reasoning] #emph[(LPAR), Reunion Island], volume 1955 of #emph[Lecture Notes in Computer Science], pages 70–84. Springer-Verlag, 2000.]

#refentry[Hamid, Nadeem, Zhong Shao, Valery Trifonov, Stefan Monnier, and Zhaozhong Ni. A syntactic approach to foundational proof-carrying code. In #emph[IEEE Symposium on] #emph[Logic in Computer Science (LICS)], pages 89–100, July 2002.]

#refentry[Hanson, David R. Fast allocation and deallocation of memory based on object lifetimes. #emph[Software—Practice and Experience], 20(1):5–12, 1990.]
...
#refentry[Harper, Robert, John C. Mitchell, and Eugenio Moggi. Higher-order modules and the phase distinction. In #emph[ACM Symposium on Principles of Programming Languages] #emph[(POPL), San Francisco, California], pages 341–354, January 1990.]

#refentry[Harper, Robert and Frank Pfenning. On equivalence and canonical forms in the LF type theory. #emph[ACM Transactions on Computational Logic], 2004. To appear. An earlier version is available as Technical Report CMU-CS-00-148, School of Computer Science, Carnegie Mellon University.]

#refentry[Harper, Robert and Robert Pollack. Type checking with universes. #emph[Theoretical Computer Science], 89:107–136, 1991.]

#refentry[Harper, Robert and Christopher Stone. A type-theoretic interpretation of Standard ML. In G. Plotkin, C. Stirling, and M. Tofte, editors, #emph[Proof, Language and Interaction:] #emph[Essays in Honour of Robin Milner]. MIT Press, 2000.]
...
#refentry[Hoare, C. A. R. Proof of correctness of data representation. #emph[Acta Informatica], 1: 271–281, 1972.]

#refentry[Hofmann, Martin. A mixed modal/linear lambda calculus with applications to bellantoni-cook safe recursion. In #emph[International Workshop on Computer Science] #emph[Logic (CSL), Aarhus, Denmark], pages 275–294, August 1997a.]

#refentry[Hofmann, Martin. Syntax and semantics of dependent types. In A. M. Pitts and P. Dybjer, editors, #emph[Semantics and Logic of Computation], pages 79–130. Cambridge University Press, 1997b.]

#refentry[Hofmann, Martin. Linear types and non-size-increasing polynomial time computation. In #emph[IEEE Symposium on Logic in Computer Science (LICS), Trento, Italy], pages 464–473, June 1999.]
...
#refentry[Howe, Douglas J. Proving congruence of bisimulation in functional programming languages. #emph[Information and Computation], 124(2):103–112, 1996.]

#refentry[Huet, Gérard. #emph[Résolution d’equations dans les langages d’ordre 1,2, ...,]ω. Thèse de Doctorat d’Etat, Université de Paris 7, Paris, France, 1976.]
...
#refentry[Jacobs, Bart. #emph[Categorical Logic and Type Theory]. Studies in Logic and the Foundations of Mathematics 141. Elsevier, 1999.]

#refentry[Jategaonkar, Lalita A. ML with extended pattern matching and subtypes. Master’s thesis, Massachusetts Institute of Technology, August 1989.]

#refentry[Jategaonkar, Lalita A. and John C. Mitchell. ML with extended pattern matching and subtypes (preliminary version). In #emph[ACM Symposium on Lisp and Functional Programming (LFP), Snowbird, Utah], pages 198–211, Snowbird, Utah, July 1988.]

#refentry[Jensen, Kathleen and Niklaus Wirth. #emph[Pascal User Manual and Report]. Springer-Verlag, second edition, 1975.]

#refentry[Jim, Trevor. What are principal typings and what are they good for? In #emph[ACM SIGPLAN–] #emph[SIGACT Symposium on Principles of Programming Languages (POPL), St. Petersburg] #emph[Beach, Florida], pages 42–53, 1996.]

#refentry[Jim, Trevor, J. Greg Morrisett, Dan Grossman, Michael W. Hicks, James Cheney, and Yanling Wang. Cyclone: A safe dialect of C. In #emph[General Track: USENIX Annual] #emph[Technical Conference], pages 275–288, June 2002.]

#refentry[Jim, Trevor and Jens Palsberg. Type inference in systems of recursive types with subtyping, 1999. Manuscript, available from http:\//www.cs.purdue.edu/homes/ palsberg/draft/jim-palsberg99.pdf.]
...
#refentry[Jones, Mark P. Typing Haskell in Haskell. In #emph[ACM Haskell Workshop], informal proceedings, October 1999.]

#refentry[Jones, Mark P. and John C. Peterson. The Hugs 98 user manual, 1999. Available from http:\//www.haskell.org/hugs/.]
...
#refentry[Jutting, L.S. van Benthem, James McKinna, and Robert Pollack. Checking algorithms for Pure Type Systems. In #emph[International Workshop on Types for Proofs and Programs (TYPES), Nijmegen, The Netherlands,] May 1993, volume 806 of #emph[Lecture Notes] #emph[in Computer Science], pages 19–61. Springer-Verlag, 1994.]
...
#refentry[Leroy, Xavier. Manifest types, modules and separate compilation. In #emph[ACM SIGPLAN–] #emph[SIGACT Symposium on Principles of Programming Languages (POPL), Portland,] #emph[Oregon], pages 109–122, January 1994.]

#refentry[Leroy, Xavier. Applicative functors and fully transparent higher-order modules. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages] #emph[(POPL), San Francisco, California], pages 142–153, January 1995.]

#refentry[Leroy, Xavier. A syntactic theory of type generativity and sharing. #emph[Journal of Functional Programming], 6(5):667–698, September 1996.]

#refentry[Leroy, Xavier. The Objective Caml system: Documentation and user’s manual, 2000. With Damien Doligez, Jacques Garrigue, Didier Rémy, and Jérôme Vouillon. Available from http:\//caml.inria.fr.]

#refentry[Leroy, Xavier and François Pessaux. Type-based analysis of uncaught exceptions. #emph[ACM Transactions on Programming Languages and Systems], 22(2):340–377, March 2000. Summary in #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), San Antonio, Texas], 1999.]
...
#refentry[Luo, Zhaohui and Robert Pollack. The LEGO proof development system: A user’s manual. Technical Report ECS-LFCS-92-211, University of Edinburgh, May 1992.]

#refentry[MacQueen, David. Modules for Standard ML. In #emph[ACM Symposium on Lisp and Functional Programming (LFP), Austin, Texas], pages 198–207, 1984.]

#refentry[MacQueen, David. Using dependent types to express modular structure. In #emph[ACM] #emph[Symposium on Principles of Programming Languages (POPL), St. Petersburg Beach,] #emph[Florida], pages 277–286, January 1986.]

#refentry[MacQueen, David B. and Mads Tofte. A semantics for higher-order functors. In #emph[European Symposium on Programming (ESOP), Edinburgh, Scotland], volume 788 of #emph[Lecture Notes in Computer Science], pages 409–423. Springer-Verlag, April 1994.]
...
#refentry[Makholm, Henning. #emph[A Language-Independend Framework for Region Inference]. PhD thesis, University of Copenhagen, Department of Computer Science, Copenhagen, Denmark, 2003.]
...
#refentry[McAllester, David. A logical algorithm for ML type inference. In #emph[International Conference on Rewriting Techniques and Applications (RTA), Valencia, Spain], volume 2706 of #emph[Lecture Notes in Computer Science], pages 436–451. Springer-Verlag, June 2003.]

#refentry[McBride, Conor. #emph[Dependently Typed Functional Programs and their Proofs]. PhD thesis, LFCS, University of Edinburgh, Edinburgh, Scotland, 2000.]

#refentry[McBride, Conor and James McKinna. The view from the left. #emph[Journal of Functional] #emph[Programming], 14(1):69–111, 2004.]

#refentry[McKinna, James and Robert Pollack. Pure Type Sytems formalized. In #emph[International] #emph[Conference on Typed Lambda Calculi and Applications (TLCA), Utrecht, The Netherlands], volume 664 of #emph[Lecture Notes in Computer Science], pages 289–305. Springer-Verlag, March 1993.]

#refentry[Melski, David and Thomas Reps. Interconvertibility of a class of set constraints and context-free language reachability. #emph[Theoretical Computer Science], 248(1–2), November 2000.]
...
#refentry[Minamide, Yasuhiko, Greg Morrisett, and Robert Harper. Typed closure conversion. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages] #emph[(POPL), St. Petersburg Beach, Florida], pages 271–283, January 1996.]

#refentry[Miquel, Alexandre. #emph[Le calcul des constructions implicite: syntaxe et sémantique]. PhD thesis, University Paris 7, Paris, France, 2001.]
...
#refentry[Mitchell, John C. #emph[Foundations for Programming Languages]. MIT Press, 1996.]

#refentry[Mitchell, John C. and Gordon D. Plotkin. Abstract types have existential types. #emph[ACM] #emph[Transactions on Programming Languages and Systems], 10(3):470–502, 1988. Summary in #emph[ACM Symposium on Principles of Programming Languages (POPL), New] #emph[Orleans, Louisiana], 1985.]

#refentry[Moggi, Eugenio. Computational lambda-calculus and monads. In #emph[IEEE Symposium] #emph[on Logic in Computer Science (LICS), Asilomar, California], pages 14–23, June 1989. Full version, titled #emph[Notions of Computation and Monads], in Information and Computation, 93(1), pp. 55–92, 1991.]

#refentry[Moh, Shaw-Kwei. The deduction theorems and two new logical systems. #emph[Methodos], 2: 56–75, 1950.]

#refentry[Mohring, Christine. Algorithm development in the calculus of constructions. In #emph[IEEE] #emph[Symposium on Logic in Computer Science (LICS), Cambridge, Massachusetts], pages 84–91, June 1986.]

#refentry[Monnier, Stefan, Bratin Saha, and Zhong Shao. Principled scavenging. In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI),] #emph[Snowbird, Utah], pages 81–91, June 2001.]

#refentry[Morrisett, Greg, Karl Crary, Neal Glew, and David Walker. Stack-based typed assembly language. #emph[Journal of Functional Programming], 12(1):43–88, January 2002.]

#refentry[Morrisett, Greg, David Walker, Karl Crary, and Neal Glew. From System-F to typed assembly language. #emph[ACM Transactions on Programming Languages and Systems], 21(3):527–568, May 1999.]
...
#refentry[Necula, George C. #emph[Compiling with Proofs]. PhD thesis, Carnegie Mellon University, Pittsburgh, Pennsylvania, September 1998. Technical report CMU-CS-98-154.]

#refentry[Necula, George C. Translation validation for an optimizing compiler. In #emph[ACM SIGPLAN Conference on Programming Language Design and Implementation (PLDI),] #emph[Vancouver, British Columbia, Canada], pages 83–94, June 2000.]

#refentry[Necula, George C. and Peter Lee. Safe kernel extensions without run-time checking. In #emph[USENIX Symposium on Operating Systems Design and Implementation (OSDI),] #emph[Seattle, Washington], pages 229–243, October 1996.]
...
#refentry[Niehren, Joachim and Tim Priesnitz. Non-structural subtype entailment in automata theory. #emph[Information and Computation], 186(2):319–354, November 2003.]

#refentry[Nielson, Flemming and Hanne Riis Nielson. From CML to its process algebra. #emph[Theoretical Computer Science], 155:179–219, 1996.]

#refentry[Nielson, Flemming, Hanne Riis Nielson, and Christopher L. Hankin. #emph[Principles of Program Analysis]. Springer-Verlag, 1999.]
...
#refentry[Nöcker, Erick and Sjaak Smetsers. Partially strict non-recursive data types. #emph[Journal] #emph[of Functional Programming], 3(2):191–215, 1993.]

#refentry[Nöcker, Erick G. M. H., Sjaak E. W. Smetsers, Marko C. J. D. van Eekelen, and Marinus J. Plasmeijer. Concurrent clean. In #emph[Symposium on Parallel Architectures and] #emph[Languages Europe, Volume I: Parallel Architectures and Algorithms (PARLE), Eindhoven, The Netherlands], volume 505 of #emph[Lecture Notes in Computer Science], pages 202–219. Springer-Verlag, June 1991.]

#refentry[Odersky, Martin. Observers for linear types. In #emph[European Symposium on Programming (ESOP), Rennes, France], volume 582 of #emph[Lecture Notes in Computer Science], pages 390–407. Springer-Verlag, February 1992.]

#refentry[Odersky, Martin, Vincent Cremet, Christine Rockl, and Matthias Zenger. A nominal theory of objects with dependent types. In #emph[International Workshop on Foundations] #emph[of Object-Oriented Languages (FOOL)], informal proceedings, 2003.]

#refentry[Odersky, Martin, Martin Sulzmann, and Martin Wehr. Type inference with constrained types. #emph[Theory and Practice of Object Systems], 5(1):35–55, 1999. Summary in #emph[International Workshop on Foundations of Object-Oriented Languages (FOOL)], informal proceedings, 1997.]

#refentry[O’Hearn, Peter. On bunched typing. #emph[Journal of Functional Programming], 13(4):747– 796, 2003.]

#refentry[O’Hearn, Peter and David Pym. The logic of bunched implications. #emph[Bulletin of Symbolic] #emph[Logic], 5(2):215–244, 1999.]

#refentry[Ohori, Atsushi. A polymorphic record calculus and its compilation. #emph[ACM Transactions on Programming Languages and Systems], 17(6):844–895, November 1995.]

#refentry[Ohori, Atsushi and Peter Buneman. Type inference in a database programming language. In #emph[ACM Symposium on Lisp and Functional Programming (LFP), Snowbird,] #emph[Utah], pages 174–183, July 1988.]
...
#refentry[Palsberg, Jens and Michael I. Schwartzbach. #emph[Object-Oriented Type Systems]. Wiley, 1994.]

#refentry[Palsberg, Jens, Mitchell Wand, and Patrick M. O’Keefe. Type inference with non-structural subtyping. #emph[Formal Aspects of Computing], 9:49–67, 1997.]
...
#refentry[Petersen, Leaf, Perry Cheng, Robert Harper, and Chris Stone. Implementing the TILT internal language. Technical Report CMU-CS-00-180, Department of Computer Science, Carnegie Mellon University, 2000.]

#refentry[Petersen, Leaf, Robert Harper, Karl Crary, and Frank Pfenning. A type theory for memory allocation and data layout. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), New Orleans, Louisiana], pages 172–184, January 2003.]
...
#refentry[Pierce, Benjamin C. and David N. Turner. Object-oriented programming without recursive types. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming] #emph[Languages (POPL), Charleston, South Carolina], pages 299–312, January 1993.]

#refentry[Pitts, Andrew M. Relational properties of domains. #emph[Information and Computation], 127:66–90, 1996.]

#refentry[Pitts, Andrew M. Existential types: Logical relations and operational equivalence. In #emph[International Colloquium on Automata, Languages and Programming (ICALP),] #emph[Aalborg, Denmark], volume 1443 of #emph[Lecture Notes in Computer Science], pages 309– 326. Springer-Verlag, 1998.]

#refentry[Pitts, Andrew M. Parametric polymorphism and operational equivalence. #emph[Mathematical Structures in Computer Science], 10:321–359, 2000.]

#refentry[Pitts, Andrew M. Operational semantics and program equivalence. In G. Barthe, P. Dybjer, and J. Saraiva, editors, #emph[Applied Semantics, Advanced Lectures], volume 2395 of #emph[Lecture Notes in Computer Science, Tutorial], pages 378–412. Springer-Verlag, 2002.]

#refentry[Pitts, Andrew M. and Ian D. B. Stark. Observable properties of higher order functions that dynamically create local names, or: What’s new? In #emph[International Symposium] #emph[on Mathematical Foundations of Computer Science, Gda´nsk, Poland], volume 711 of #emph[Lecture Notes in Computer Science], pages 122–141. Springer-Verlag, 1993.]
...
#refentry[Pollack, Robert. #emph[The Theory of LEGO: A Proof Checker for the Extended Calculus of] #emph[Constructions]. PhD thesis, University of Edinburgh, Edinburgh, Scotland, 1994.]

#refentry[Popkorn, Sally. #emph[First Steps in Modal Logic]. Cambridge University Press, 1994.]

#refentry[Pottier, François. A versatile constraint-based type inference system. #emph[Nordic Journal] #emph[of Computing], 7(4):312–347, November 2000.]

#refentry[Pottier, François. A semi-syntactic soundness proof for HM(X). Research Report 4150, INRIA, March 2001a.]

#refentry[Pottier, François. Simplifying subtyping constraints: a theory. #emph[Information and Computation], 170(2):153–183, November 2001b.]
...
#refentry[Rémy, Didier. Projective ML. In #emph[ACM Symposium on Lisp and Functional Programming] #emph[(LFP), San Francisco, California], pages 66–75, June 1992b.]

#refentry[Rémy, Didier. Syntactic theories and the algebra of record terms. Research Report 1869, Institut National de Recherche en Informatique et Automatisme, Rocquencourt, BP 105, 78 153 Le Chesnay Cedex, France, 1993.]
...
#refentry[Restall, Greg. #emph[An Introduction to Substructural Logics]. Routledge, February 2000.]
...
#refentry[Reynolds, John C. Syntactic control of interference, part 2. Report CMU-CS-89-130, Carnegie Mellon University, April 1989.]
...
#refentry[Russo, Claudio V. #emph[Types for Modules]. PhD thesis, Edinburgh University, Edinburgh, Scotland, 1998. LFCS Thesis ECS–LFCS–98–389.]

#refentry[Russo, Claudio V. Non-dependent types for standard ML modules. In #emph[ACM SIGPLAN] #emph[International Conference on Principles and Practice of Declarative Programming] #emph[(PPDP), Paris France], pages 80–97, September 1999.]

#refentry[Russo, Claudio V. Recursive structures for Standard ML. In #emph[ACM SIGPLAN International Conference on Functional Programming (ICFP), Firenze, Italy], pages 50–61, September 2001.]

#refentry[Sabry, Amr. What is a purely functional language? #emph[Journal of Functional Programming], 8(1):1–22, January 1998.]

#refentry[Saha, Bratin, Nevin Heintze, and Dino Oliva. Subtransitive CFA using types. Technical Report YALEU/DCS/TR-1166, Yale University, Department of Computer Science, October 1998.]
...
#refentry[Sestoft, Peter. Replacing function parameters by global variables. In #emph[ACM Symposium on Functional Programming Languages and Computer Architecture (FPCA),] #emph[London, England], pages 39–53, September 1989. Also available as University of Copenhagen, Department of Computer Science Technical Report 88-7-2.]
...
#refentry[Shao, Zhong. Typed cross-module compilation. In #emph[ACM SIGPLAN International Conference on Functional Programming (ICFP), Baltimore, Maryland], pages 141–152, September 1998.]

#refentry[Shao, Zhong. Transparent modules with fully syntactic signatures. In #emph[ACM SIGPLAN] #emph[International Conference on Functional Programming (ICFP), Paris, France], pages 220–232, September 1999.]
...
#refentry[Statman, Richard. Logical relations and the typed λ-calculus. #emph[Information and Control], 65(2–3):85–97, May–June 1985.]

#refentry[Steele, Guy L., Jr. #emph[Common Lisp: The Language]. Digital Press, 1990.]

#refentry[Stone, Christopher A. #emph[Singleton Kinds and Singleton Types]. PhD thesis, Carnegie Mellon University, Pittsburgh, Pennsylvania, August 2000.]

#refentry[Stone, Christopher A. and Robert Harper. Deciding type equivalence in a language with singleton kinds. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), Boston, Massachusetts], pages 214–227, January 2000.]

#refentry[Stone, Christopher A. and Robert Harper. Extensional equivalence and singleton types. 2005. To appear.]
...
#refentry[Sulzmann, Martin, Martin Müller, and Christoph Zenger. Hindley/Milner style type systems in constraint form. Research Report ACRC–99–009, University of South Australia, School of Computer and Information Science, July 1999.]

#refentry[Sumii, Eijiro and Benjamin C. Pierce. A bisimulation for type abstraction and recursion. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), Long Beach, California], 2005.]
...
#refentry[Terlouw, J. Een nadere bewijstheoretische analyse van GSTTs. Manuscript, University of Nijmegen, Netherlands, 1989.]

#refentry[Thorup, Kresten Krab. Genericity in Java with virtual types. In #emph[European Conference on Object-Oriented Programming (ECOOP), Jyväskylä, Finland], volume 1241 of #emph[Lecture Notes in Computer Science], pages 444–471. Springer-Verlag, June 1997.]

#refentry[Tiuryn, Jerzy. Subtype inequalities. In #emph[IEEE Symposium on Logic in Computer Science] #emph[(LICS), Santa Cruz, California], pages 308–317, June 1992.]

#refentry[Tiuryn, Jerzy and Mitchell Wand. Type reconstruction with recursive types and atomic subtyping. In #emph[Theory and Practice of Software Development (TAPSOFT),] #emph[Orsay, France], volume 668 of #emph[Lecture Notes in Computer Science], pages 686–701. Springer-Verlag, April 1993.]

#refentry[Tofte, Mads. #emph[Operational Semantics and Polymorphic Type Inference]. PhD thesis, Computer Science Department, Edinburgh University, Edinburgh, Scotland, 1988.]

#refentry[Tofte, Mads and Lars Birkedal. A region inference algorithm. #emph[ACM Transactions on] #emph[Programming Languages and Systems], 20(4):724–767, 1998.]

#refentry[Tofte, Mads, Lars Birkedal, Martin Elsman, and Niels Hallenberg. Region-based memory management in perspective. In #emph[ACM SIGPLAN International Conference on] #emph[Principles and Practice of Declarative Programming (PPDP), Firenze, Italy], pages 175–186, September 2001a.]

#refentry[Tofte, Mads, Lars Birkedal, Martin Elsman, Niels Hallenberg, Tommy Højfeld Olesen, and Peter Sestoft. Programming with regions in the ML Kit (for version 4). Technical report, IT University of Copenhagen, October 2001b.]

#refentry[Tofte, Mads and Jean-Pierre Talpin. Implementing the call-by-value lambda-calculus using a stack of regions. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of] #emph[Programming Languages (POPL), Portland, Oregon], January 1994.]

#refentry[Tofte, Mads and Jean-Pierre Talpin. Region-based memory management. #emph[Information] #emph[and Computation], 132(2):109–176, February 1997.]
...
#refentry[Vouillon, Jerome and Paul-André Melliès. Semantic types: A fresh look at the ideal model for types. In #emph[ACM SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), Venice, Italy], pages 52–63, 2004.]

#refentry[Wadler, Philip. Theorems for free! In #emph[ACM Symposium on Functional Programming] #emph[Languages and Computer Architecture (FPCA), London, England], pages 347–359, September 1989.]
...
#refentry[Walker, David and Greg Morrisett. Alias types for recursive data structures. In #emph[ACM] #emph[SIGPLAN Workshop on Types in Compilation (TIC), Montréal, Québec,] September, 2000, volume 2071, pages 177–206. Springer-Verlag, 2001.]

#refentry[Walker, David and Kevin Watkins. On regions and linear types. In #emph[ACM SIGPLAN] #emph[International Conference on Functional Programming (ICFP), Firenze, Italy], pages 181–192, September 2001.]

#refentry[Wand, Mitchell. Complete type inference for simple objects. In #emph[IEEE Symposium on] #emph[Logic in Computer Science (LICS), Ithaca, New York], pages 37–44, June 1987a.]

#refentry[Wand, Mitchell. A simple algorithm and proof for type inference. #emph[Fundamenta Informaticae], 10:115–122, 1987b.]
...
#refentry[Wells, Joe B. Typability and type checking in system F are equivalent and undecidable. #emph[Annals of Pure and Applied Logic], 98(1–3):111–156, 1999.]

#refentry[Wells, Joe B. The essence of principal typings. In #emph[International Colloquium on Automata, Languages and Programming (ICALP)], volume 2380 of #emph[Lecture Notes in] #emph[Computer Science], pages 913–925. Springer-Verlag, 2002.]

#refentry[Werner, Benjamin. #emph[Une Théorie des Constructions Inductives]. PhD thesis, Université Paris 7, Paris, France, May 1994.]

#refentry[Wirth, Niklaus. #emph[Systematic Programming: An Introduction]. Prentice Hall, 1973.]

#refentry[Wirth, Niklaus. #emph[Programming in Modula-2]. Texts and Monographs in Computer Science. Springer-Verlag, 1983.]

#refentry[Wright, Andrew K. Simple imperative polymorphism. #emph[Lisp and Symbolic Computation], 8(4):343–355, 1995.]

#refentry[Wright, Andrew K. and Robert Cartwright. A practical soft type system for Scheme. In #emph[ACM Symposium on Lisp and Functional Programming (LFP), Orlando, Florida], pages 250–262, June 1994. Full version available in #emph[ACM Transactions on Programming Languages and Systems], 19(1):87–52, January 1997.]

#refentry[Wright, Andrew K. and Matthias Felleisen. A syntactic approach to type soundness. #emph[Information and Computation], 115(1):38–94, November 1994.]

#refentry[Xi, Hongwei. #emph[Dependent Types in Practical Programming]. PhD thesis, Carnegie Mellon University, Pittsburgh, Pennsylvania, 1998.]

#refentry[Xi, Hongwei and Robert Harper. A dependently typed assembly language. In #emph[ACM SIGPLAN International Conference on Functional Programming (ICFP), Firenze, Italy], pages 169–180, September 2001.]

#refentry[Xi, Hongwei and Frank Pfenning. Dependent types in practical programming. In #emph[ACM] #emph[SIGPLAN–SIGACT Symposium on Principles of Programming Languages (POPL), San] #emph[Antonio, Texas], pages 214–227, January 1999.]

#refentry[Zenger, Christoph. Indexed types. #emph[Theoretical Computer Science], 187:147–165, 1997.]

#refentry[Zwanenburg, Jan. Pure type systems with subtyping. In #emph[International Conference] #emph[on Typed Lambda Calculi and Applications (TLCA), L’Aquila, Italy], volume 1581 of #emph[Lecture Notes in Computer Science], pages 381–396. Springer-Verlag, April 1999.]
