...
#align(center)[
  #v(3cm)
  #text(size: 24pt)[Поглиблені теми з типів]
  #v(0.3cm)
  #text(size: 24pt)[та мов програмування]
  #v(1.5cm)
  #text(size: 13pt)[за редакцією Benjamin C. Pierce]
  #v(2cm)
  #text(size: 11pt)[
    Переклад українською: розділи 1--10\
    #v(0.3cm)
    (додатки, покажчик і бібліографію ще не перекладено)
  ]
  #v(1.2cm)
